...
class Users:
    ...
    def add_user(self,name,number,address,password):
        ...
        Notification.registration_confirmation(self,str(number),str(name),str(date))
    ...
    def today_order(self,number,date,restro_id,sum):
        ...
        Notification.order_placed_notification_to_user(self,str(restro_name),str(number),str(date),str(sum),"30",str(number))
        restro_number=Restaurant.show_restro_by_name1(self,restro_name)
        address=Users.find_user_details(self,number)
        Notification.order_received_notification_to_restro(self,str(restro_name),str(number),str(date),str(sum),str(restro_number),str(address))
...
if __name__ == '__main__':
    R=Users()
    #R.today_order(7054538345,"18-09-2020","Gia188Del",40)
    #print(R.find_user_details(9876543210))
    #R.today_order(7838,'17-09-2020','Gia188Del',0)
